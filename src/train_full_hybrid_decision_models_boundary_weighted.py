"""
Train full hybrid cycle-level decision models using boundary-weighted reconstruction outputs.
...
METHOD_FAMILY_DIR = (
    ...
    / "output"
    / "intermediate_csv"
    / "method_family_queue_length_evaluation_boundary_weighted"
)
...
OUT_DIR = PROJECT_ROOT / "output" / "intermediate_csv" / "full_hybrid_decision_models_boundary_weighted"
