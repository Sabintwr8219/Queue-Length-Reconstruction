...
OUT_DIR = PROJECT_ROOT / "output" / "intermediate_csv" / "ml_direct_predictions"
...
MODEL_FAMILIES = [
    ...
    ModelFamily(
        family_name="ml_cv",
        prediction_prefix="ml_cv",
        numeric_features=ML_CV_NUMERIC_FEATURES,
        categorical_features=ML_CV_CATEGORICAL_FEATURES,
